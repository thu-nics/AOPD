#!/bin/bash
# ============================================================================
# TicTacToe —— VinePPO + outcome（结果）奖励 训练脚本
# ============================================================================
set -euo pipefail
...
VINE_K="${VINE_K:-1}"
VINE_TRAIN_TRAJ="${VINE_TRAIN_TRAJ:-null}"
VINE_MC_ENABLE_THINKING="${VINE_MC_ENABLE_THINKING:-False}"
...
echo "=== TicTacToe | VinePPO + outcome reward ==="
