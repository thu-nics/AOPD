...
SAVE_FREQ="${SAVE_FREQ:-10}"           # checkpoint 保存间隔
...
STATE_GROUP_ADVANTAGE_MODE="${STATE_GROUP_ADVANTAGE_MODE:-mean_then_batch_whiten}"  # group_whiten 或 mean_then_batch_whiten
