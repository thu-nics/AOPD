#!/bin/bash
# ============================================================================
# TicTacToe —— Turn-Level PPO TD-GAE + outcome（结果）奖励 训练脚本
# ============================================================================
set -euo pipefail
...
echo "=== TicTacToe | Turn-Level PPO TD-GAE + outcome reward (32x8) ==="
...
echo "Reward: outcome only | critic: turn-level TD-GAE | opponent: $OPPONENT | mcts_sims: $MCTS_SIMS | invalid: $INVALID_PENALTY"
