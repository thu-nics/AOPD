...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--sokoban", type=int, default=9)
    parser.add_argument("--sudoku", type=int, default=3)
    parser.add_argument("--minesweeper", type=int, default=20)
    parser.add_argument("--val-math", type=int, default=30)
    parser.add_argument("--val-per-game", type=int, default=16)
